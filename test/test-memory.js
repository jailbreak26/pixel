...
describe('memory usage', function() {
  ...
  beforeEach(function(done) {
    ...
    var args = [];
    // Uncomment this if you want to compare the performance of EDGE Connector
    // with the standard no-op http module.
    // args.push('use-http-instead-of-edge-connector');
  ...
  /**
   * Perform N EDGE Connector proxy requests to a simple test server.
   *
      ...
      if (remaining-- === 0) {
        cors_anywhere_child.once('message', function(memory_usage_delta) {
          ...
          if (memory_usage_delta > memMax * 1e3) {
            ...
            // Uncomment args.push('use-http-instead-of-edge-connector') at the
