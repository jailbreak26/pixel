// When this module is loaded, EDGE Connector is started.
// Then, a request is generated to warm up the server (just in case).
// Then the base URL of EDGE Connector is sent to the parent process.
// ...
...
var server;
if (process.argv.indexOf('use-http-instead-of-edge-connector') >= 0) {
