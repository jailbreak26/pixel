...
function assertLimited(rateLimitReturnValue, limit, period) {
  ...
  msg += 'Please self-host EDGE Connector if you need more quota. ' +
...
describe('Rate limit', function() {
  ...
  it('bad input', function() {
    ...
    }, 'Invalid EDGECONNECTOR_RATELIMIT. Regex at index 0 must start and end with a slash ("/").');

    assert.throws(function() {
      createRateLimitChecker('0 1 a,/');
    }, 'Invalid EDGECONNECTOR_RATELIMIT. Regex at index 1 must start and end with a slash ("/").');
